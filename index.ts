...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		description: [
			...
			"- scout (DeepSeek V4 Flash): Quick surface-level exploration — list files, read headers, find patterns. Use FIRST for unfamiliar repos.",
			...
			"- doc-writer (DeepSeek V4 Flash): Generate documentation, READMEs, API docs from source code. Use AFTER understanding the codebase.",
			"",
